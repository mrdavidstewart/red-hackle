...
export const metadata = buildMetadata({
  title: `Commercial Cleaning Careers ${serviceAreaStatement}`,
  description:
    `Commercial cleaning careers ${serviceAreaStatement} With a structured team culture.`,
  path: "/careers",
})
