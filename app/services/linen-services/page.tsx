...
export const metadata = buildMetadata({
    ...
    description:
        "Professional linen laundering and rental services for serviced accommodation and short-stay properties across the East Coast of Scotland.",
            ...
            <section className="relative overflow-hidden bg-gray-950 text-white">
                ...
                <div className="relative mx-auto w-full max-w-6xl px-4 py-16 sm:px-6">
                    ...
                    <p className="mt-4 max-w-2xl text-lg text-gray-300">
                        ...
                        <br /><br />
                        This flexible approach allows operators to select the most suitable option for their operation, occupancy levels, and budget.
                    </p>
                ...
                <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6">
                    <Card className="border border-gray-200">
                        <CardContent className="space-y-4 p-6">
                            ...
                            <p className="text-gray-600">
                                <strong>Why it works:</strong> Integrated linen support reduces operational complexity and ensures properties are consistently guest-ready without last-minute logistics issues.
                            </p>
                            <h2 className="text-2xl font-semibold text-gray-900">Coverage</h2>
                            <p className="text-gray-600">
                                Linen laundering and rental services are available as part of our housekeeping support across the East Coast of Scotland, including Tayside, Angus, Fife, Perth, Aberdeen & Aberdeenshire.
                            </p>
                        </CardContent>
                    </Card>
                </div>
