...
export const metadata = buildMetadata({
  title: "Office Cleaning Services | East Coast Scotland",
  description:
    "Office and workplace cleaning across Dundee, Angus, Fife, and the East Coast of Scotland with flexible schedules and quality reporting.",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "We support multi-site office portfolios across Dundee, Angus, and Fife with consistent reporting and supervision.",
  },
]
      ...
      <section className="relative overflow-hidden bg-gray-950 text-white">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 py-16 sm:px-6">
          ...
          <p className="mt-4 max-w-2xl text-lg text-gray-300">
            ...
            accountability. We support live office environments in Dundee, Angus, and Fife with daily or out-of-hours
          ...
          <Card className="border border-gray-200">
            <CardContent className="space-y-4 p-6">
              ...
              <p className="text-gray-600">
                Office cleaning delivered across Broughty Ferry, Dundee, Angus, Fife, and St Andrews as part of our East
                Coast of Scotland coverage.
              </p>
            </CardContent>
          </Card>
        </div>
