...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      {/* E-commerce Section - Now Fully Functional */}
      <section className="py-16 md:py-20 bg-black">
        <div className="container mx-auto px-4 sm:px-6 max-w-full">
          <div className="text-center mb-12 md:mb-16">
            <Badge className="bg-blue-500/10 border border-blue-500/30 text-blue-400 mb-6">
              <ShoppingBag className="w-4 h-4 mr-2" />
              Now Available
            </Badge>
            <h2 className="text-3xl md:text-4xl font-black mb-6 text-white">Red Hackle Cleaning Supplies</h2>
            <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto">
              Professional-grade cleaning products now available for purchase. The same quality supplies we use in our
              services, delivered to your door across Scotland.
            </p>
          </div>

          {/* Add this right after the section header and before the product categories */}
          <div className="bg-gradient-to-r from-green-600/20 to-green-500/20 border border-green-500/30 rounded-2xl p-6 mb-8 text-center">
            <div className="flex items-center justify-center space-x-3 mb-3">
              <Truck className="w-6 h-6 text-green-400" />
              <span className="text-2xl font-bold text-green-400">FREE DELIVERY</span>
              <Truck className="w-6 h-6 text-green-400" />
            </div>
            <p className="text-white text-lg font-semibold mb-2">On all orders over £50 across Scotland</p>
            <p className="text-gray-300">Stock up on your cleaning supplies and save on delivery costs!</p>
          </div>
            ...
            {[
              {
                ...
                desc: "Commercial-grade supplies used by our team",
                count: products.filter((p) => p.category === "cleaning").length,
              },
              {
                icon: Truck,
                title: "FREE Delivery Over £50",
                desc: "Free delivery across Scotland on orders £50+",
                count: "Save £5-15",
              },
              {
                icon: CreditCard,
                title: "Secure Payment",
                desc: "Invoice-based ordering system",
                count: "Safe & Easy",
              },
              {
                icon: Shield,
                title: "Quality Guaranteed",
                desc: "Same standards as our cleaning services",
                count: "100%",
              },
            ].map((feature, index) => (
              <Card key={index} className="bg-gray-900/50 border border-blue-500/20">
                <CardContent className="p-4 md:p-6 text-center">
                  ...
                  <p className="text-gray-400 text-xs md:text-sm mb-2">{feature.desc}</p>
                  <Badge className="bg-blue-600/20 border border-blue-500/30 text-blue-400">{feature.count}</Badge>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="flex justify-center mb-8">
            <Button onClick={() => setIsCartOpen(true)} className="bg-red-600 hover:bg-red-700 text-white relative">
          ...
          <div className="text-center bg-gray-900/50 rounded-2xl p-8 border border-red-500/20">
            <h3 className="text-2xl font-bold text-white mb-4">Need Bulk Orders?</h3>
            <p className="text-gray-400 mb-6">Contact us directly for volume discounts and custom orders</p>
